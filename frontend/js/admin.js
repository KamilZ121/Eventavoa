...
function removeOrderItem() { const customer = $(this).data("customer"); request({method: "removeOrderItem", item_id: $(this).data("id")}, "POST").done(function () { $(`.customer-orders[data-id="${customer}"]`).trigger("click"); }); }
